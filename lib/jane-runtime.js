...
const JANE_SESSION_TOOLS = [
  ...
  },
  {
    ...
    description: 'Update the Bitácora — Jane\'s living research log for the active Trail. Write what you learned about the workspace, the data, working hypotheses, and the researcher\'s goals. This persists across sessions and helps future-you understand the project context.',
    inputSchema: {
      type: 'object',
      properties: {
        text: { type: 'string', description: 'The full Bitácora text. This replaces the current content (not appended).' },
      },
      required: ['text'],
    },
  },
